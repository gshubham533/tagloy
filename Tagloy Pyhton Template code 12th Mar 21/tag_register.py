...
def send_quick_reply(phone):
    ...
    payload = '{"to": "91'+str(phone)+'","type": "template","template": {"namespace": "f53c59d0_208b_4e32_afc8_cc646e53ee2a","name": "tag_register","language": {"policy": "deterministic","code": "en"},"components": [{"type": "body","parameters": [{"type": "text","text": "on behalf of *Diageo*"},{"type": "text","text": "*Raising the Bar initiative by Diageo*"}]},{"type": "button","sub_type": "quick_reply","index": "1","parameters": [{"type": "payload","payload": "More Information"}]}]}}'
    headers = {
        'Content-Type': "application/json",
        'Authorization': "Bearer " + authkey
    }
